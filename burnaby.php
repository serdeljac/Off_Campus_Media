...
<html lang="en-us">
<head>
	<title>Off Campus - Burnaby</title>
	<meta charset="utf-8" />
	<link rel="stylesheet" href="css_php/default.css" />
	<link rel="stylesheet" href="css_php/eventpage.css" />
</head>
...
|*******************************************************************************************************************-->
	<?php include("css_php/header.php");?>
		<span id="pagetitle"><a href="events.php">Events</a> > Burnaby</span></span>
	<hr class="border">
...
|*******************************************************************************************************************-->
	...
	<main>
		<h1 id="noevents">Sorry. There are no upcoming events.</h1>
	</main>
</div>
